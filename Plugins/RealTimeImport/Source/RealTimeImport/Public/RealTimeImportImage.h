...
public:
	...
	void removeTextureFromCacheAndDestroyTexture(UTexture2D* texture, bool emptyTextureBeforeDeleting);
...
private:
	...
	TArray<uint8> resizeRawImageData(TArray<uint8> sourceData, int32 sourceX, int32 sourceY, int32 targetX, int32 targetY, EPixelFormat pixelformat, bool SRGB);
